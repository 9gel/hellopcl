...
@implementation HPCLAppDelegate
...
-(IBAction)information:(UIButton*)sender
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        [self.viewController presentViewController:container animated:YES completion:NULL];
    }
    else
    {
...
-(IBAction) opacitySliderValueChanged:(UISlider*)sender
{
    ...
    vesKiwiPCLDemo* rep = app->getPCLDemo();
