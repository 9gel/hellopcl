...
# define vtksys_SIZEOF_LONG_LONG 1
#elif __LONG_LONG_MAX__ == 0x7fff
# define vtksys_SIZEOF_LONG_LONG 2
#elif __LONG_LONG_MAX__ == 0x7fffffff
# define vtksys_SIZEOF_LONG_LONG 4
...
#define vtksys_CHAR_IS_SIGNED 0
